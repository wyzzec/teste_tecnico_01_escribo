...
void main() {
  ...
  int somaValoresDivisiveisPor5 (int numero) {
    int somaTotal = 0;
    if (numero == 0){
      return 0;
    }
  ...
  do {
    ...
    if (numeroDigitadoPeloUsuario != null){
      print('Soma total de divisiveis por 3 ou 5: ${somaValoresDivisiveisPor3(int.parse(numeroDigitadoPeloUsuario)) + somaValoresDivisiveisPor5(int.parse(numeroDigitadoPeloUsuario))}\n');
